...
public class BSTindex <Key extends Comparable<Key>, Value>{
    ...
    {
        public Key key; // key
        public ArrayList<Value> val; // associated value
    ...
    { // Return value associated with key in the subtree rooted at x;
        ...
        else return x.val.get(0); // return the first value by default
    }
...
// Otherwise, add new node to subtree associating key with val.
    ...
    public static void main(String[] args){
        ...
        BSTindex<Integer,Integer> bst = new BSTindex<Integer, Integer>();
